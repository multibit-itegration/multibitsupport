...
@Component({
  ...
  template: `
    <div class="timeout">
      <div class="timeout-message">Время ожидания оценки истекло!</div>
  ...
  styles: [
    `
    .timeout{max-width:800px;margin:0 auto;padding:20px}
    .timeout-message{background:#6635f3;color:#fff;padding:30px;border-radius:8px;text-align:center;font-size:18px;font-weight:500;margin-bottom:20px;line-height:1.5}
    ...
    @media (max-width: 480px){
      .timeout{padding:12px}
      .timeout-message{padding:18px;font-size:16px;border-radius:10px}
